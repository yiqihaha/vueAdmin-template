<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" @click="handleCreate" type="primary" icon="edit">添加角色</el-button>
    </div>
    ...
    <el-table :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column min-width="300px" label="角色名称">
        <template scope="scope">
      ...
      <el-table-column min-width="300px" label="角色中文名称">
        <template scope="scope">
          <span class="link-type" @click="handleUpdate(scope.row)">{{scope.row.title}}</span>
          <el-tag>{{scope.row.roleNameCn}}</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column width="80px" label="是否已激活">
        <template scope="scope">
...
<script>
  ...
  import {fetchRoleWithAuthorities} from 'api/login';
